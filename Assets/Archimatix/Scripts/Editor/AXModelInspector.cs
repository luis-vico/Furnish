	...
	public override void OnInspectorGUI ()
	{
		...
		if (model.displayModelDefaults) {
			...
			if (GUILayout.Button (infoIconTexture, GUIStyle.none, new GUILayoutOption[] {
				...
				Application.OpenURL ("https://www.archimatix.com/manual/materials"); 
			}
			...
			if (GUILayout.Button (infoIconTexture, GUIStyle.none, new GUILayoutOption[] {
				...
				Application.OpenURL ("https://www.archimatix.com/manual/lightmapping-with-archimatix"); 
			}
...
//					labelSty.richText = true;
		...
		if (model.displayModelSelectedNodes) {
			...
			if (GUILayout.Button (infoIconTexture, GUIStyle.none, new GUILayoutOption[] {
				...
				Application.OpenURL ("https://www.archimatix.com/manual/node-selection"); 
			}
