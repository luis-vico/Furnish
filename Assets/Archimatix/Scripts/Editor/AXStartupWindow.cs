...
public class AXStartupWindow : EditorWindow
{
	...
	{
		Application.OpenURL("https://archimatix.com/documentation");
	}
...
*/
            ...
            // User GUIDE
            if (GUILayout.Button("<b>User Guide </b>\n<size=12>/Assets/Archimatix/Documentation/UserGuide.pdf</size>", richButtonStyle, GUILayout.MaxWidth(400), GUILayout.Height(36)))
            {
                string file = System.Environment.CurrentDirectory + "/Assets/Archimatix/Documentation/UserGuide.pdf";
            ...
            if (GUILayout.Button("<b>Tutorial Videos </b>\n<size=12>Watch a range of how-tos</size>", richButtonStyle, GUILayout.MaxWidth(400), GUILayout.Height(36)))
				Application.OpenURL("https://www.archimatix.com/tutorials");
