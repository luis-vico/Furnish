...
namespace AX.Generators
{
	...
	public class UVProjector : AX.Generators.Generator3D, IHandles
	{
		...
		public AXParameter P_TopY;
		public AXParameter P_BaseY;
		...
		public override void init_parametricObject()
		{
			...
			// GEOMETRY_CONTROLS
			parametricObject.addParameter(AXParameter.DataType.Option, "ProjectionAxis", (int)Axis.NZ);
			...
			//parametricObject.addParameter(AXParameter.DataType.Float, "TopY", 0f);
			//parametricObject.addParameter(AXParameter.DataType.Float, "BaseY", 1f);
		...
		public override void pollInputParmetersAndSetUpLocalReferences()
		{
			...
			P_TopY = parametricObject.getParameter("TopY");
			P_BaseY = parametricObject.getParameter("BaseY");
		...
		public override void pollControlValuesFromParmeters()
		{
			...
			topY = (P_TopY != null) ? P_TopY.FloatVal : 0.0f;
			baseY = (P_BaseY != null) ? P_BaseY.FloatVal : 1.0f;
		...
		public void AutoSetBoundsRect()
		{
			...
			if (P_TopY != null)
			{
				P_TopY.initiatePARAMETER_Ripple_setFloatValueFromGUIChange(y2 - .01f);
			}
			if (P_BaseY != null)
			{
				P_BaseY.initiatePARAMETER_Ripple_setFloatValueFromGUIChange(y1 + .01f);
			}
