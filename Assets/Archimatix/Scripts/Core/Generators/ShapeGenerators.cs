...
namespace AX.Generators
{
	...
	public class FrozenShape : AX.Generators.Generator2D, IShape
	{
		...
		public override GameObject generate(bool makeGameObjects, AXParametricObject initiator_po, bool isReplica)
		{
			...
			// Debug.Log("P_Output="+P_Output+ " -- " + P_Output.paths + " :: " + parametricObject.Name + " " + parametricObject.frozenPaths);

			if (P_Output.paths == null)
			{
				Paths paths = new Paths();
				if (parametricObject.frozenPath0 != null)
					paths.Add(parametricObject.frozenPath0);
				if (parametricObject.frozenPath1 != null)
					paths.Add(parametricObject.frozenPath1);
				if (parametricObject.frozenPath2 != null)
					paths.Add(parametricObject.frozenPath2);
				P_Output.paths = paths;
			}
