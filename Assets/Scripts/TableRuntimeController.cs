...
public class TableRuntimeController : AXRuntimeControllerBase {
	...
	private AXParameter P_TableEdit_SizeX;
	private AXParameter P_TableEdit_SizeY;
	private AXParameter P_TableEdit_SizeZ;
	...
	public float TableEdit_SizeX {
		get {
			if (model != null)
				return P_TableEdit_SizeX.FloatVal;
			return 0;
		}
		set {
			if (P_TableEdit_SizeX != null)
			{
				P_TableEdit_SizeX.setValue(value);
				parameterWasAltered = true;
			}
		}
	}
	public float TableEdit_SizeY {
		get {
			if (model != null)
				return P_TableEdit_SizeY.FloatVal;
			return 0;
		}
		set {
			if (P_TableEdit_SizeY != null)
			{
				P_TableEdit_SizeY.setValue(value);
				parameterWasAltered = true;
			}
		}
	}
	public float TableEdit_SizeZ {
		get {
			if (model != null)
				return P_TableEdit_SizeZ.FloatVal;
			return 0;
		}
		set {
			if (P_TableEdit_SizeZ != null)
			{
				P_TableEdit_SizeZ.setValue(value);
				parameterWasAltered = true;
			}
		}
	}
	...
	{
		P_TableEdit_SizeX	= model.getParameter ("TableEdit_SizeX");
		P_TableEdit_SizeY	= model.getParameter ("TableEdit_SizeY");
		P_TableEdit_SizeZ	= model.getParameter ("TableEdit_SizeZ");
	}
	...
	public void setX(){
		TableEdit_SizeX = sliderX.GetComponent<Slider>().value;
	}

	public void setY(){
		TableEdit_SizeY = sliderY.GetComponent<Slider>().value;
	}

	public void setZ(){
		TableEdit_SizeZ = sliderZ.GetComponent<Slider>().value;
	}
